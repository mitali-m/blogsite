    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">NTU Graduate with Honors (Highest Distinction), Python/Java/Web Developer, Machine Learning Researcher</span><strong class="text-slider"></strong></p>
