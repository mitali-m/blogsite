    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">NTU Undergraduate with Honors (Highest Distinction), Python/Java/Web Developer, Machine Learning Researcher</span><strong class="text-slider"></strong></p>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    I also strongly believe in learning outside of textbooks, which I have tried to 
                    achieve through various co-curricular activities and by learning new languages.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                ...
                track-records to experience first-hand research
              </p>
            </div>
          </div>
        </div>
...
<!--         </div> -->
        <div class="col-sm-3 col-lg-3">
          <div class="counter-box pt-4 pt-md-0">
            <div class="counter-ico">
              <span class="ico-circle"><i class="ion-android-volume-up"></i></span>
            </div>
            <div class="counter-num">
              <p class="counter">5</p>
              <span class="counter-text">PROFICIENT LANGUAGES</span>
            </div>
          </div>
        </div>
        <div class="col-sm-3 col-lg-3">
